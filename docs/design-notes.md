# Resonance Desk — design notes

The long-form record of how the desk is built and why each part works the way it does.
The short version, and the link to the live site, is in [the README](../README.md).
